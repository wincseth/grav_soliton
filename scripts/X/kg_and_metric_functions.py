...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 09:24:01 2024
...
def iterate_kg_and_metric(A, B, zeta_vals, zeta_s, zeta_max, A_0_guess1, A_0_guess2, zeta_0):
    '''
    ...
    while eps_error > converge_tol:
        ...
        if np.isnan(np.sum(A_array1)) or np.isnan(np.sum(A_array2)):
            ...
            return u_bar, epsilon, a_array, b_array, eps_rounds, False
        ...
        print(f"metric_rounds: {metric_rounds}, Current A[0]: {a_array[0]},")
