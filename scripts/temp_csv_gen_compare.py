...
from temp_functions import integrating_inside_out
import pandas as pd
...
def main():
    ...
    if zeta_s_start > 0.1:
        ...
        a_array_xavi = df0[f'A of {zeta_s_start}'].to_numpy()
        b_array_xavi = df0[f'B of {zeta_s_start}'].to_numpy()
    ...
    print(f"looping through {zeta_s_vals}\n")
    ...
    for i, zeta_s in enumerate(zeta_s_vals):
        ...
        u_bar_xavi, epsilon_xavi, a_array_xavi, b_array_xavi, eps_rounds_xavi, working_conv_xavi = integrating_inside_out(a_array_xavi, b_array_xavi, ZETA, zeta_s, ZETA_MAX, prev_g1, prev_g2, ZETA_0)
