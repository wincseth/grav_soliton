...
import numpy as np
from temp_kg_and_metric_functions import find_fixed_metric
from temp_kg_and_metric_functions import iterate_kg_and_metric
import pandas as pd
...
a2 = [0.71, 0.72, 0.73]
a3 = np.linspace(0.74, 0.7432, 15)#a3 = np.linspace(0.74, 0.7427, 6)
...
def main():
    ...
    for i, zeta_s in enumerate(zeta_s_vals):
        ...
        print(f"zeta_s values: {zeta_s_vals}, epsilons: {epsilons}, A0's: {A_0s}")
        ...
        input("Press any key to continue to next zeta_s... ")
